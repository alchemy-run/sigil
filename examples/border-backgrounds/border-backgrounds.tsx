...
function BorderBackgrounds() {
  return (
    <Box flexDirection="column" gap={1}>
      <Box borderStyle="round" borderColor="white" borderBackgroundColor="blue" padding={1}>
        <Text>Box with blue background on white border</Text>
      </Box>

      <Box borderStyle="single" borderColor="black" borderBackgroundColor="yellow" padding={1}>
      ...
      <Box borderStyle="bold" borderColor="#FF00FF" borderBackgroundColor="#00FF00" padding={1}>
