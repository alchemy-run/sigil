...
import { render, Box, Text, Static } from "../../src/index.ts";
    ...
    <Box flexDirection="column">
      ...
      <Box flexDirection="column" padding={1}>
        ...
        <Box marginTop={1} width={60}>
          <Text>
            Cupcake ipsum dolor sit amet candy candy. Sesame snaps cookie I love tootsie roll apple
            pie bonbon wafer. Caramels sesame snaps icing cotton candy I love cookie sweet roll. I
            love bonbon sweet.
          </Text>
        </Box>
